...
const Footer: React.FC = () => {
  ...
  return (
    <motion.footer
      className={`py-6 px-6 text-center text-zinc-600 dark:text-zinc-400 border-t border-zinc-200 dark:border-zinc-800 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-center space-x-6 mb-4">
          <motion.a
            ...
            className="text-zinc-700 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50 cursor-pointer transition-colors duration-300"
          >
        ...
        >
          © {year} Caio Reis. {t('footer.rights')}.
        </motion.p>
      </div>
    </motion.footer>
  );
